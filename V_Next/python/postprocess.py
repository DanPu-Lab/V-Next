...
def add_vcf_info(work, reference, merged_vcf, candidates_vcf,
...
def postprocess(work, reference, pred_vcf_file, output_vcf, candidates_vcf,
    ...
    add_vcf_info(work, reference, merged_vcf,
                 candidates_vcf, output_vcf,
                 pass_threshold, lowqual_threshold)

    logger.info("Output V_Next prediction at {}".format(output_vcf))
