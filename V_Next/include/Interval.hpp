...
inline V_Next::bio::GenomicInterval<Contig> Intersect(const V_Next::bio::GenomicInterval<Contig> &x, const V_Next::bio::GenomicInterval<Contig> &y)
{
  // return a 0 length interval if non-overlap
  V_Next::bio::GenomicInterval<Contig> ret;
