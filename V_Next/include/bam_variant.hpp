...
std::vector<V_Next::bio::Variant<std::string, Contig>> GetIndels(const BamRecord& bam) {
  std::vector<V_Next::bio::Variant<std::string, Contig>> result;
...
template<typename BamRecord, typename Contig>
std::vector<V_Next::bio::Variant<std::string, Contig>> GetSNVs(const BamRecord& bam) {
  std::vector<V_Next::bio::Variant<std::string, Contig>> result;
  std::string mdstr;
  ...
  std::vector<V_Next::bio::Variant<std::string, Contig>> snvs_MDTags;
...
template<typename BamRecord, typename Contig>
std::vector<V_Next::bio::Variant<std::string, Contig>> GetVars(const BamRecord& bam) {
